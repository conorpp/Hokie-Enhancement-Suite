/*
    This is a nearly complete first draft of email notification add on for client side
    
    You will be notifed via email when a spot for a class opens up when you click a button.
    
    The half finished backend is in server.js
    
    ****the problem is that you need to have a non-expired session cookie to crawl the time table
